...
export default function ResultsTable({ rows }: { rows: Row[] }) {
  ...
  const filtered = useMemo(() => {
    ...
    return rows.filter(r => {
      ...
      const matchesFilter = filter === "all" || (filter === "correct" ? r.ok : !r.ok);
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              style={{
                paddingLeft: 26, paddingRight: 8, height: 28, width: 160,
                border: "1px solid var(--border)", borderRadius: 0,
      ...
      {rows.length === 0 ? (
        ...
        <>
          <table>
            ...
            <tbody>
              {paginated.map(({ matchNumber, home, away, hs, as_, h, d, a, pred, actual, ok }) => (
